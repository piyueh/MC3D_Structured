...
INTEGER*4,ALLOCATABLE::iNnumcell(:,:,:),iNbgcell(:,:,:) !iNbgcell:累計到第(i-1,j,k)網格時的總聲子束數量
...
REAL*8::TEMP_HEAT(2),dEheatflux0,sumQ
! phonon information
INTEGER*4::iNph,newiNph,iNprop,iNmakeup
REAL*8, ALLOCATABLE::phn(:,:),newphn(:,:)
! simulation parameters
REAL*8:: dt, bundle(2), time0, time
! output data
REAL*8, ALLOCATABLE:: Tz(:,:,:),qflow(:,:),qctrl(:,:),qctrl0(:,:)
integer*4:: abc,cba

CHARACTER*255::inputfilename, outputfilename, restartfilename
!===================================================================================
