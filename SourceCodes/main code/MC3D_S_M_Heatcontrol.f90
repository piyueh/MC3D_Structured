...
!======================================================================
    ...
    IMPLICIT NONE
    INTEGER(KIND=4):: Nmax, s, m, k, ip, j, i, npool
    INTEGER(KIND=4):: bg, ed
    REAL(KIND=8), ALLOCATABLE:: phnheat(:, :), cellheat(:,:), rannum(:,:)
    INTEGER(KIND=4), ALLOCATABLE:: im(:, :, :, :)
    REAL(KIND=8):: tmp
...
!======================================================================
    ...
    REAL(KIND=8):: TL(iNcell(2), iNcell(3))
    REAL(KIND=8):: TR(iNcell(2), iNcell(3))
    REAL(KIND=8):: dNum,dUL,dUR
    !------------------------------------------------------------------
