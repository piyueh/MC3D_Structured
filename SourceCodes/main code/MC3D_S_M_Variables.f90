...
INTEGER(KIND=4):: iter0, iterations, noutput, ct, backupstep


!output data
!======================================================================
!----------------------------------------------------------------------
REAL(KIND=8), ALLOCATABLE:: Tz(:, :, :), Ez(:, :, :)
REAL(KIND=8), ALLOCATABLE:: qflow(:, :), qflowL(:, :), qflowR(:, :)
REAL(KIND=8), ALLOCATABLE:: qctrl(:, :)
